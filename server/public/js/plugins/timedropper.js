(function($) {
	var
		// CSS EVENT DETECT timedropper  dateDropper
		csse = {
	...
	var
		picker_node_el = 'div.timedropper.picker-focus';
	...
	$.fn.timeDropper = function(options) {
		return $(this).each(function(){
			if($(this).is('input')&&!$(this).hasClass('picker-input')) {

				var
					input = $(this),
					id = 'timedropper-' + Object.keys(pickers).length;
				...
				$('<div>', {
					class: 'timedropper ' + picker_modal + ' ' + picker_theme + ' ' + picker_fx_class + ' ' + picker_large_class,
					id: id,
					html: $('<div>', {
						class: 'picker'
					})
